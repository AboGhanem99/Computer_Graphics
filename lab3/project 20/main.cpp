...
public:
    ...
    bool Init()
    {
        Vector3f Pos(0.0f, 0.0f, 4.0f);
        Vector3f Target(0.0f, 0.0f, 1.0f);
        Vector3f Up(0.0, 3.0f, 0.0f);
        ...
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/graphics/lab3/project20/pas.png");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Point light source")) {
        return 1;
    }
