...
public:
    ...
    bool Init()
    {
        ...
        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/dev/projects/Content/test.png");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Shadow map - part 2")) {
        return 1;
    }
