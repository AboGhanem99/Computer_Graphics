...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("C:/dev/projects/Content/box.obj")) {
            return false;
        }
               
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/dev/projects/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/dev/projects/Content/normal_map.jpg");
        
        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "C:/dev/projects/Content/normal_up.jpg");
